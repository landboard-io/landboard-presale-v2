...
const BuyCard = () => {
	...
	const disabled = egldAmount === "0" || landAmount === "0" || !egldAmount || !landAmount || !address;
	...
	return (
		<motion.div variants={variants} className="pb-10 card">
			...
			<form className="flex flex-col gap-5 text-left" onSubmit={buyToken}>
				...
				<Button className="w-full filled" containerClassname="mt-5" type="submit" hideComingSoon disabled>
					BUY $LAND
				</Button>
